        ...
        <span className="inline-flex items-center justify-center mt-4 sm:ml-auto sm:mt-0 sm:justify-start">
          <div className="flex items-center justify-center gap-2 text-xl social-icons ">
            <a
              ...
              rel="noreferrer"
              className={
                "p-2 duration-500 rounded-xl hover:bg-[#3b5998] " +
                (pathname === "/" ? "bg-gray-800/90" : "bg-orange-600/90")
              }
            >
              <svg
                width={20}
            ...
            <a
              ...
              rel="noreferrer"
              className={
                "p-2 duration-500 rounded-xl hover:bg-[#55acee] " +
                (pathname === "/" ? "bg-gray-800/90" : "bg-orange-600/90")
              }
            >
              <svg
            ...
            <a
              ...
              rel="noreferrer"
              className={
                "p-2 duration-500 rounded-xl hover:bg-[#3077b5] " +
                (pathname === "/" ? "bg-gray-800/90" : "bg-orange-600/90")
              }
            >
              <svg
            ...
            <a
              ...
              rel="noreferrer"
              className={
                "p-2 duration-500 rounded-xl hover:bg-[#161b22] " +
                (pathname === "/" ? "bg-gray-800/90" : "bg-orange-600/90")
              }
            >
              <svg
